...
class BSITblock(nn.Module):
    def __init__(
        ...
        if args.pca:#debug
            num_t_pints = args.pca_features #debug
        elif args.forward_selection or args.feature_selection_wrapper:#debug
            num_t_pints = len(args.current_features)
        else:
