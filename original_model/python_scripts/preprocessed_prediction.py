...
train_dataloader = DataLoader(dataset , batch_size = 64, num_workers = 3)
test_dataloader = DataLoader(dataset_test , batch_size = 64, num_workers = 3)
...
if args.is_training :
    print("Training...")
    trainer = L.Trainer(max_epochs= 100 , devices= 1, accelerator=device)
...
print("normalized_confusion_matrix:")
print(normalized_confusion_matrix)
#np.delete(normalized_confusion_matrix, 4, 0)#delete 4th row
#print(normalized_confusion_matrix)
